...
$active 		= "SELECT * from registrations WHERE id = '{$active_id}'  ";
...
<div class="sign-u">
<input type="email" placeholder="Email Address" value="<?php if(isset($email)){echo $email; } ?>" name="email" readonly>
<div class="clearfix"> </div>
</div>
...
<div class="sign-u">
<input type="text" placeholder="Designation" name="designation" value="<?php if(isset($designation)){echo $designation; } ?>" required="">
<div class="clearfix"> </div>
</div>
