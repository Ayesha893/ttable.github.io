...
<h2 class="title1">Faculty Registration</h2>
...
$registration = "INSERT INTO registrations (firstname,lastname,email,phone,address,gender,password,conpassword,status, designation, type, role) VALUES ('{$firstname}','{$lastname}','{$email}','{$number}','{$address}','{$gender}','{$password}','{$conpassword}',0, '{$designation}', '{$type}', 'faculty')";
