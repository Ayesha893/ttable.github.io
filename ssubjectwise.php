...
<h2 class="title1">Subject Wise Timetable</h2>
<div class="sign-up-row widget-shadow">
<h5>From here you view the timetable of any Subject.</h5>
...
$fetch 			= "SELECT * FROM timetables WHERE subjectid = '{$subjectid}' AND status = 1";
...
<a class="pull-right btn btn-warning" href="sdownload.php?subjectid=<?php echo $subjectid ?>" style="margin-bottom:5px !important">Download</a>
